...
class EncryptFixture : public benchmark::Fixture {
public:
...
private:
  void vthe_encrypt_builder(const size_t sz) {
...
BENCHMARK_DEFINE_F(EncryptFixture, BM_encrypt_8192)(benchmark::State &state) {
  for (auto _ : state) {
...
BENCHMARK_REGISTER_F(EncryptFixture, BM_encrypt_8192)
